									...
									<div class="widget-title">
										...
										<div class="btn-group">
											<input style="margin: 5px; padding: 0px 5px;" id="next"
												class="btn btn-primary" type="submit" value="Add Time"
												onclick="form.action='TrackingServlet?action=addForwardTime';" />
											<input style="margin: 5px; padding: 0px 5px;" id="next"
												class="btn btn-primary" type="submit" value="Edit Time"
												onclick="form.action='TrackingServlet?action=editForwardTime';" />
											<input style="margin: 5px; padding: 0px 5px;" id="next"
												class="btn btn-primary" type="submit" value="Delete Time"
												onclick="form.action='TrackingServlet?action=deleteTime';" />
										</div>
										<div id="status"></div>
									</div>
							...
							<div id="form-wizard-1" class="step">
								<table class="table table-bordered data-table">
									...
									<div class="widget-title">
										...
										<div class="btn-group">
											<input style="margin: 5px; padding: 0px 5px;"
												class="btn btn-primary" type="submit"
												value="Add Modification"
												onclick="form.action='TrackingServlet?action=addForwardMod';" />
											<input style="margin: 5px; padding: 0px 5px;" id="next"
												class="btn btn-primary" type="submit"
												value="Edit Modification"
												onclick="form.action='TrackingServlet?action=editForwardMod';" />
											<input style="margin: 5px; padding: 0px 5px;" id="next"
												class="btn btn-primary" type="submit"
												value="Delete Modification"
												onclick="form.action='TrackingServlet?action=deleteMod';" />
										</div>
										<div id="status"></div>
									</div>
